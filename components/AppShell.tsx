...
export function AppShell() {
  ...
  return <div className="app-shell">
    ...
    <main className="studio"><Topbar onMenu={() => setSidebarOpen(true)} /><div className="top-grid"><LibraryConsole category={libraryCategory} /><Turntable /><NowPlaying /></div><AnalogPanel /></main>
    <ErrorToast />
  </div>;
}
